...
public enum ItemType {
	...
	CLASSIC_BURGER_SALAD(Sprite.BASIC_TABLE, "burger classique", true, false, true),
	CLASSIC_BURGER_TOMATO(Sprite.BASIC_TABLE, "burger classique", true, true, false),
	CLASSIC_BURGER_SALAD_TOMATO(Sprite.BASIC_TABLE, "burger classique", true, false, false),
	...
	VEGI_BURGER_SALAD(Sprite.BASIC_TABLE, "burger classique", true, false, true),
	VEGI_BURGER_TOMATO(Sprite.BASIC_TABLE, "burger classique", true, true, false),
	VEGI_BURGER_SALAD_TOMATO(Sprite.BASIC_TABLE, "burger classique", true, false, false),
