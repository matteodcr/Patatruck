...
public class Recipe {
	...
	public static ItemType cook(ItemType type) {
		return cookRecipe.get(type);
	}

	public static ItemType cut(ItemType type) {
		return cutRecipe.get(type);
	}

	public static ItemType fry(ItemType type) {
		return fryRecipe.get(type);
	}

	public static ItemType assemble(List<ItemType> list) {
