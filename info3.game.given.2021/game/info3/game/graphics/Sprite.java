...
public enum Sprite {
	...
	public enum Spritesheet {
		...
		COOKEDFRIES_("Sprite_cuisine_ingredient/cookedfries.png", 13),
		COOKEDHASHMEAT_("Sprite_cuisine_ingredient/cookedhashmeat.png", 13),
		...
		GALETTECOOKED_("Sprite_cuisine_ingredient/galettecooked.png", 13),
		...
		POTATOCOOKED_("Sprite_cuisine_ingredient/potatocooked.png", 13),
