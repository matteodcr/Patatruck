...
public enum ItemType {
	...
	BREAD(Sprite.COWBOY0, "pain", false, false, false);

	Sprite sprite;
	String DisplayName;
	boolean sauceAllowed = false;
	boolean saladAllowed = false;
	boolean tomatoAllowed = false;

	ItemType(Sprite sprite, String DisplayName, boolean sauceAllowed, boolean saladAllowed, boolean tomatoAllowed) {
		this.sprite = sprite;
		this.DisplayName = DisplayName;
		this.sauceAllowed = sauceAllowed;
		this.saladAllowed = saladAllowed;
		this.tomatoAllowed = tomatoAllowed;
	}
